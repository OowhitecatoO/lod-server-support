...
# Base worlds are MC-version-specific; a 26.x world will not downgrade to 1.21.11. Clear a
# stale base BEFORE Step 1 so its '! -d "$BASE_WORLD_DIR/world"' check regenerates naturally
# (must run before that check — clearing after staging would boot 1.21.11 against a 26.x world).
