...
- **Patch for the Minecraft 1.21.11 line** — The same fixes also ship as `v0.8.1` (MC 26.2) and `v0.8.1+mc26.1`. Safe to update straight from v0.8.0 or any earlier install; client and server can update independently.
