...
> tags are `v<x.y.z>+mc26.1` (a bare `v<x.y.z>` collides with MAINLINE tags; since the
> trigger scoping it also simply does not fire this branch's release.yml). Commits land on
> `support/mc26.1` directly (NOT via PR to main — step 3 below is mainline-only; this branch
...
> at `docs/release-notes-v<x.y.z>+mc26.1.md`. Every VSS/voxy/84zcagOb pitfall below is
