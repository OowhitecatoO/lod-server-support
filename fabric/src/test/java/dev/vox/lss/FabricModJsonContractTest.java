 ...
 * jar genuinely breaks on 26.2 (its pinned {@code publishServer} mixin descriptor matches
 * neither of 26.2's overloads), so the bound is load-bearing, not cosmetic.
 */
