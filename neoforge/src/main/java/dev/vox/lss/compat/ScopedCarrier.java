...
/**
 * The 1.21.1 PASS-THROUGH variant of the ScopedCarrier (V-2/S5's whole-file swap —
 * see main's twin for the 26.x ScopedValue shim): Java 21 has no final ScopedValue,
 * and this line's AntiXray (1.4.x+1.21.1) threads its obfuscation context through
